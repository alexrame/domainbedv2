...
save_model_bleu="/gpfswork/rech/edr/utr15kn/dataplace/ExpansionNet_v2/github_ignore_material/saves/fts/model_bleu_epoch5_v2.pth /gpfswork/rech/edr/utr15kn/dataplace/ExpansionNet_v2/github_ignore_material/saves/fts/model_bleu_epoch5it6293bs18.pth"
save_model_rouge="/gpfswork/rech/edr/utr15kn/dataplace/ExpansionNet_v2/github_ignore_material/saves/fts/model_rouge_epoch5_v2.pth /gpfswork/rech/edr/utr15kn/dataplace/ExpansionNet_v2/github_ignore_material/saves/fts/model_rouge_epoch5it6293bs18.pth"
for coeff in 0.0 0.1 0.2 0.25 0.3 0.35 0.4 0.45 0.5 0.55 0.6 0.65 0.7 0.75 0.8 0.85 0.9 1.0
do
	/gpfswork/rech/edr/utr15kn/conda/envs/pytorch/bin/python3 /gpfsdswork/projects/rech/edr/utr15kn/domainbedv2/captioning/test_singlegpu.py \
		--is_end_to_end False --ensemble wa --coeffs [$coeff] --save_model_path $save_model_bleu $save_model_rouge \
		--features_path /gpfswork/rech/edr/utr15kn/dataplace/ExpansionNet_v2/github_ignore_material/raw_data/features_rf.hdf5
done
